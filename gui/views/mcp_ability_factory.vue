            ...
            <div v-show="collapsibleBoxOpen">
              <div v-if="uiPhase === 'idle' || uiPhase === 'finished'">
                ...
                <blockquote class="example-prompt">
                  I want to create a few abilities related to persistence with WMI
                  for Windows, then create an adversary with those abilities.
                  Please create more than one ability.
                </blockquote>
                ...
                <p
                  v-if="!isModelConfigValid"
                  class="help is-warning"
                >
                  Please configure and save a valid model before submitting.
                </p>
              </div>
            </div>
          </div>
